...
def test_graveyard_fill_order_h9_to_a10():
    ...
    assert names[8:] == ['a10', 'b10', 'c10', 'd10', 'e10', 'f10', 'g10', 'h10']
...
def test_white_graveyard_fill_order_a0_to_h_minus1():
    ...
    assert names[8:] == ['h-1', 'g-1', 'f-1', 'e-1', 'd-1', 'c-1', 'b-1', 'a-1']
...
def test_graveyard_pose_map_offsets_from_h9():
    ...
    assert gmap.square_center_xy(7, 1) == (100.0, 240.0)
    assert gmap.square_center_xy(0, 1) == (380.0, 240.0)
...
def test_white_graveyard_pose_map_offsets_from_a0():
    ...
    assert gmap.square_center_xy(0, 1) == (100.0, 160.0)
    assert gmap.square_center_xy(7, 1) == (380.0, 160.0)
